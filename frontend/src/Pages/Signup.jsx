        ...
        <div className="flex w-screen flex-wrap text-slate-800 sm:mb-5 md:mb-0">
            <div className="relative hidden h-screen select-none flex-col justify-center bg-gray-800 text-center md:flex md:w-1/2">
                <div className="mx-auto py-16 px-8 text-white xl:w-[40rem]">
                    ...
                    <Link to='#' className='font-semibold text-2xl tracking-wide text-white underline underline-offset-4'>Welcome</Link>
                </div>
            </div>
            <div className="flex w-full font-semibold flex-col md:w-1/2">
                ...
                <div className="my-auto mx-auto flex flex-col justify-center px-6 pt-8 md:justify-start lg:w-[28rem]">
                    ...
                    <p className="mt-6 text-center font-medium md:text-left">
                        Already using Shopzey ?
                       <Link to='/login' className='whitespace-nowrap font-semibold text-gray-700 hover:underline ml-1'>Login Here</Link>
                    </p>
                    ...
                    >
                        ...
                        <input
                            className={`border p-2 border-slate-300 w-full font-semibold outline-none ${errors.name ? 'border-red-500' : 'border-gray-300'
                                }`}
                            type="text"
                ...
                <input
                    className={`border p-2 border-slate-300 w-full font-semibold outline-none ${
